...
export const HourlyForecast = ({ hourlyData, units }) => {
  ...
  return (
    <div className="glass-card rounded-3xl p-8 text-white animate-fade-in">
      ...
      <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-hide">
        {next24Hours.map((hour, index) => (
          ...
          >
            <div className="text-sm text-white text-opacity-80 mb-3 font-medium">
              {formatHour(hour.dt)}
            </div>
            <div className="mb-3">
              <WeatherAnimation 
        ...
        {next7Days.map((day, index) => (
          ...
          >
            <div className="flex items-center space-x-6 flex-1">
              <div className="w-20 text-white text-opacity-90 font-semibold text-lg">
                {formatDay(day.dt)}
              </div>
              ...
              <div className="flex-1 text-white text-opacity-80 capitalize font-medium">
